      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-3 z-30 pointer-events-auto">
        {slides.map((_, index) => (
          <button
            ...
            className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${index === current ? 'bg-fashion-eggshell w-8' : 'bg-fashion-eggshell/50 hover:bg-fashion-eggshell/80'
              }`}
